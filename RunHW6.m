...
[trim_variables, fval] = min_trim_fun_1(trim_definition,aircraft_parameters);
...
for i=1:n_ind
    ...
    wind_angles(:,i) = AirRelativeVelocityToWindAngles(air_rel_vel_body);
    ...
    [control_slc, x_c_slc] = SimpleSLCAutopilot(Ts*(i-1), aircraft_array(:,i), wind_angles(:,i), control_objectives, control_gain_struct,wind_inertial);
    ...
    %%% Aircraft dynamics
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    [TOUT2,YOUT2] = ode45(@(t,y) AC_EOM(t,y,control_array(:,i),wind_inertial,aircraft_parameters),TSPAN,aircraft_array(:,i),[]);
