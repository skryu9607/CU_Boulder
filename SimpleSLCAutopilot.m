function [control_input, x_command] = SimpleSLCAutopilot(time, aircraft_state, wind_angles, control_objectives, control_gain_struct,wind_inertial)
%
...
%   3/2/2023 - EWF converted into form for use with ode45 for ASEN 5519
    ...
    flight_angles   = FlightPathAnglesFromstate(aircraft_state,wind_inertial); %[Vg, chi, gamma]
